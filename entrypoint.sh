...
docker build --build-arg A_ENV=dev --build-arg A_API_MGT_ELU=http://internal-billing-dev-api-alb-1953497531.us-west-2.elb.amazonaws.com:3006 --build-arg A_API_MGT_REPORT=http://internal-billing-dev-api-alb-1953497531.us-west-2.elb.amazonaws.com:3008 --build-arg A_OLD_MGT=http://mgt-dev.ecv-billing-center.com --build-arg A_DATAPLATFORM=http://dataplatform-dev.ecv-billing-center.com --build-arg A_CBMS=http://cbms-dev.ecv-billing-center.com -t billing-dataplatform .
