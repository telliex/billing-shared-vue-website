...
<script lang="ts" setup name="CreditownerReportbu">
  ...
  let tableName = ref(t('report.creditownerReportbu.tableAreaTitle'));
  let reportType = 'billing_credit_report_bu'; // report type & S3 prefix folder name,
  ...
  function exportFile() {
    ...
    jsonToSheetXlsx({
      ...
      filename: `credit_bu_${timeStamp}.xlsx`,
      write2excelOpts: {
        bookType: 'xlsx'
      },
    });
