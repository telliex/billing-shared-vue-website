...
<script lang="ts" setup name="InternalPOR1CC">
  ...
  let tableName = ref(t('report.internalpor1cc.tableAreaTitle'));
  ...
  function handleChildFormValue(values: SearchItems) {
    ...
    let S3FileName = `${S3ReportClass}_${dayjs(values.YearMonth).format('YYYYMM').toString()}_30_1_migration_por1.csv`; // [for need to modify area]
