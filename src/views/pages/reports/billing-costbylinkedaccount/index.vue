...
<script lang="ts" setup name="Costbylinked">  //[for need to modify area]
  ...
  let tableName = ref(t('report.costbylinkedReport.tableAreaTitle')); //[for need to modify area]
  let reportType = ref('billing_costbylinked_report'); // [M] report type & S3 prefix folder name,
