...
<script lang="ts" setup name="CostallocateReport">  //[for need to modify area]
  ...
  let tableName = ref(t('report.costallocateReport.tableAreaTitle')); //[for need to modify area]
  let reportType = ref('billing_cost_allocate_report'); // [M] report type & S3 prefix folder name,
