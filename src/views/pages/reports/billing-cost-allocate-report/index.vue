...
<script lang="ts" setup name="CostallocateReport">
  ...
  let tableName = ref(t('report.costallocateReport.tableAreaTitle'));
  let reportType = 'billing-cost-allocate-report'; // report type & S3 prefix folder name,
  ...
  function exportFile() {
    ...
    jsonToSheetXlsx({
      ...
      filename: `cost_allocate_${timeStamp}.xlsx`,
      write2excelOpts: {
        bookType: 'xlsx'
      },
    });
