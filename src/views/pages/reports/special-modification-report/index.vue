...
<script lang="ts" setup name="SpecialReport">
  ...
  let tableName = ref(t('report.specialReport.tableAreaTitle'));
  let reportType = 'special_modifications_data'; // report type & S3 prefix folder name,
  ...
  function exportFile() {
    ...
    jsonToSheetXlsx({
      ...
      filename: `special_mod_${timeStamp}.xlsx`,
      write2excelOpts: {
        bookType: 'xlsx',
      },
    });
