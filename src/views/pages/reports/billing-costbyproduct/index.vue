...
<script lang="ts" setup name="Costbyproduct">
  ...
  let tableName = ref(t('report.costbyproductReport.tableAreaTitle')); //[for need to modify area]
  let reportType = ref('billing_costbyproduct_report'); // [M] report type & S3 prefix folder name,
