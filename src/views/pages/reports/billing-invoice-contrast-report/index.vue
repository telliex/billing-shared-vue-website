...
<script lang="ts" setup name="InvoicecontrastReport">
  ...
  let tableName = ref(t('report.invoicecontrastReport.tableAreaTitle'));
  let reportType = 'billing_invoice_contrast_report'; // report type & S3 prefix folder name,
  ...
  function exportFile() {
    ...
    jsonToSheetXlsx({
      ...
      filename: `invoice_contrast_${timeStamp}.xlsx`,
      write2excelOpts: {
        bookType: 'xlsx'
      },
    });
