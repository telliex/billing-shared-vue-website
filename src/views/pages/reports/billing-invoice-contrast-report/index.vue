...
<script lang="ts" setup name="InvoicecontrastReport">  //[for need to modify area]
  ...
  let tableName = ref(t('report.invoicecontrastReport.tableAreaTitle')); //[for need to modify area]
  let reportType = ref('billing_invoice_contrast_report'); // [M] report type & S3 prefix folder name,
