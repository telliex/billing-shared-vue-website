...
<script lang="ts" setup name="TaxbycnoReport">
  ...
  let tableName = ref(t('report.taxbycnoReport.tableAreaTitle'));
  let reportType = 'tax_by_cno'; // report type & S3 prefix folder name,
  ...
  function exportFile() {
    ...
    jsonToSheetXlsx({
      ...
      filename: `tax_by_cno_${timeStamp}.xlsx`,
      write2excelOpts: {
        bookType: 'xlsx'
      },
    });
