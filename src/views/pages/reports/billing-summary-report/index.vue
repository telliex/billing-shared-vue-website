...
<script lang="ts" setup name="SummeryReport">
  ...
  let tableName = ref(t('report.summeryReport.tableAreaTitle'));
  let reportType = 'billing_summary_hk'; // report type & S3 prefix folder name,
  ...
  function exportFile() {
    ...
    jsonToSheetXlsx({
      ...
      filename: `billing_summary_${timeStamp}.xlsx`,
      write2excelOpts: {
        bookType: 'xlsx',
      },
    });
