...
<script lang="ts" setup name="CreditownerReportsales">  //[for need to modify area]
  ...
  let reportType = ref('billing-credit-owner-report-sales'); // [M] report type & S3 prefix folder name,
