...
export function getBasicColumns(): BasicColumn[] {
  return [
    ...
    {
      title: 'ID_Client_Number',
      width: 150,
      sorter: true,
      dataIndex: 'IDClientNumber',
    },
    {
      title: 'SI Account',
      width: 150,
  ...
  return (() => {
    ...
    for (let index = 0; index < 40; index++) {
      arr.push({
        ...
        PayerAccountID: '114212827316',
        TaxID: '',
        ClientName: 'Globe Telecom, Inc',
        IDClientNumber: 3490,
        SIAccount: '',
        Contact: '',
        DirectNo: '',
