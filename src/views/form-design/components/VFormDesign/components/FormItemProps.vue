<!--
 * @Description: 表單項屬性，控件屬性面板
-->
<template>
  <div class="properties-content">
    <div class="properties-body" v-if="formConfig.currentItem?.itemProps">
      <Empty class="hint-box" v-if="!formConfig.currentItem.key" description="未選擇控件" />
      <Form v-else label-align="left" layout="vertical">
        ...
        <FormItem label="控制屬性" v-if="controlPropsList.length">
        ...
        <FormItem label="是否必選" v-if="!['Grid'].includes(formConfig.currentItem.component)">
