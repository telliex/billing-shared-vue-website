<template>
  <PageWrapper title="UseForm操作示例">
    <a-button class="mb-4" type="primary" @click="showDrawer"> 更改設置 </a-button>

    <Drawer v-model:visible="visible" title="更改設置" placement="right">
      ...
      <template #extra>
        <Space>
          <a-button @click="resetSettings">重置設置</a-button>
          <a-button type="primary" @click="onSettings">應用</a-button>
        </Space>
      </template>
    </Drawer>
...
<script lang="ts">
  ...
  const schemas: FormSchema[] = [
    ...
    },
    {
      ...
      componentProps: {
        options: [
          { label: '選項1', value: '1', key: '1' },
          { label: '選項2', value: '2', key: '2' },
        ],
      },
    },
    {
  ...
  const formSchemas: FormSchema[] = [
...

    {
      field: 'd4',
      component: 'Divider',
      label: '操作按鈕網格佈局(actionColOptions)',
      colProps: { span: 24 },
      componentProps: {
        orientation: 'center',
      },
