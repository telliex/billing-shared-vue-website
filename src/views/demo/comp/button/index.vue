<template>
  <PageWrapper
    contentFullHeight
    title="基礎組件"
    content=" 基礎組件依賴於ant-design-vue,組件庫已有的基礎組件,項目中不會再次進行demo展示（二次封裝組件除外）"
  >
    <a-row :gutter="[20, 20]">
      <a-col :xl="10" :lg="24">
        <a-card title="BasicButton Color">
          ...
          <div class="my-2">
            <h3>error</h3>
            <a-button color="error"> 錯誤 </a-button>
          ...
          <div class="my-2">
            <h3>ghost</h3>
            <a-button ghost color="success" class="ml-2"> 幽靈成功 </a-button>
            <a-button ghost color="warning" class="ml-2"> 幽靈警告 </a-button>
            <a-button ghost color="error" class="ml-2"> 幽靈錯誤 </a-button>
            <a-button ghost type="dashed" color="warning" class="ml-2"> 幽靈警告dashed </a-button>
            <a-button ghost danger class="ml-2"> 幽靈危險 </a-button>
          </div>
        </a-card>
      </a-col>
      <a-col :xl="14" :lg="24">
        <a-card title="BasicButton Types">
          <div class="my-2">
            <h3>primary</h3>
            <a-button type="primary" preIcon="mdi:page-next-outline"> 主按鈕 </a-button>
          ...
          <div class="my-2">
            <h3>default</h3>
            <a-button type="default"> 默認 </a-button>
            <a-button type="default" class="ml-2" disabled> 禁用 </a-button>
            <a-button type="default" class="ml-2" danger> 危險 </a-button>
          ...
          <div class="my-2">
            ...
            <a-button type="dashed" class="ml-2" danger> 危險 </a-button>
            <a-button type="dashed" class="ml-2" loading> loading </a-button>
          </div>

          <div class="my-2">
            <h3>ghost 常規幽靈按鈕通常用於有色背景下</h3>
            <div class="bg-gray-400 py-2">
              <a-button ghost type="primary" class="ml-2"> 幽靈主要 </a-button>
              <a-button ghost type="default" class="ml-2"> 幽靈默認 </a-button>
              <a-button ghost type="dashed" class="ml-2"> 幽靈dashed </a-button>
